        ...
        do {
            ...
            if (opcao == 1) {
                if (totalCadastrados == CAPACIDADE_MAX) {
                    System.out.println("Limite Máximo de Produtos!");
                    continue;
                }
                ...
                System.out.print("Número do produto (1 a " + totalCadastrados + "): ");
                int n = sc.nextInt();
                ...
                int idx = n - 1;
                System.out.println("\n-- Produto " + n + " --");
                System.out.println("Nome: " + nomes[idx]);
